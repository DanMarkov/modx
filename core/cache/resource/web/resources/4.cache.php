<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1671456028,
    'editedby' => 1,
    'editedon' => 1671509751,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1671500700,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'servicesImage',
      1 => 'upload/Automated_online_assistant.png',
      2 => 'image',
      3 => NULL,
      4 => 'image',
    ),
...
<body class="bg-black muli">
    ...
    <div class="flex justify-between">
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            ...
            <ul class="outer"><li class="row first level1"><a href="index.php?id=1" >Main</a></li><li class="row level1 parent active"><a href="index.php?id=2" >Услуги</a><ul class="inner"><li class="row first level2 active self"><a href="index.php?id=4" >NLP</a></li></ul></li><li class="row last level1"><a href="index.php?id=5" >Контакты</a></li></ul>
    ...
    <div class="pack">
        <div class="servicePageContent">
            <div class="servicePageContentImageWrapper">
                <img src="upload/Automated_online_assistant.png" alt="" />
            </div>
            <div class="servicePageContentDescription">
                <h2>
...
Natural language processing     
  ...
  array (
    ...
    '[[$service]]' => '<section class="servicePage">
    <div class="pack">
        <div class="servicePageContent">
            <div class="servicePageContentImageWrapper">
                <img src="upload/Automated_online_assistant.png" alt="" />
    ...
    <div class="flex justify-between">
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<section class="servicePage">
    <div class="pack">
        <div class="servicePageContent">
            <div class="servicePageContentImageWrapper">
                [[*servicesImage]]
...
[[*servicesTitle]]',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="servicePage">
    <div class="pack">
        <div class="servicePageContent">
            <div class="servicePageContentImageWrapper">
                [[*servicesImage]]
